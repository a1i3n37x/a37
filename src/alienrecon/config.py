...
# Check if the default wordlist exists (optional here, could be checked when tool needs it)
...
def initialize_openai_client():
    try:
        ...
        console.print("[bold red]OpenAI Authentication Error: Invalid API Key.[/bold red]")
        sys.exit(1)
